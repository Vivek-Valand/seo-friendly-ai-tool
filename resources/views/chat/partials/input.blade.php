    ...
    <div class="w-full mx-auto relative group">
        ...
        <form id="chat-form"
            ...
            <textarea id="chat-input" rows="1" placeholder="Enter website URL or ask an SEO question..."
                data-placeholder-desktop="Enter website URL or ask an SEO question..." data-placeholder-mobile="Ask about SEO"
            ...
            <div class="p-2 flex-shrink-0">
                <button type="submit" id="send-btn"
                    class="w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 shadow-lg border bg-slate-800 text-slate-500 border-slate-700/50 hover:bg-indigo-600 hover:text-white hover:border-indigo-500 group/btn">

                    <svg id="send-icon" xmlns="http://www.w3.org/2000/svg"
                        class="w-5 h-5 transform transition-transform text-slate-500 group-hover/btn:text-white"
